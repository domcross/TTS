...
def check_config(c):
    ...
    # dataloading
    _check_argument('text_cleaner', c, restricted=True, val_type=str, enum_list=['german_phoneme_cleaners', 'english_cleaners', 'phoneme_cleaners', 'transliteration_cleaners', 'basic_cleaners'])
